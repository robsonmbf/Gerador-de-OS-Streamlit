...
def show_login_page():
    ...
    <div class="info-message">
        <strong>📄 Sistema Profissional para Geração de OS</strong><br>
        • Gere OS em lote a partir de planilha de funcionários<br>
        • 142+ opções de riscos ocupacionais organizados por categoria<br>
        • Conformidade total com NR-01<br>
...
def show_main_app(user):
    ...
    st.markdown("""
    <div class="info-message">
        <strong>🆕 Novidades do Sistema:</strong><br>
        • ✅ <strong>142 opções</strong> de riscos ocupacionais organizados por categoria<br>
        • ✅ <strong>Riscos Ergonômicos:</strong> 54 opções (novo!)<br>
        • ✅ <strong>Riscos de Acidentes:</strong> 64 opções (novo!)<br>
    ...
    if uploaded_excel is not None:
        try:
            ...
            if funcionarios_selecionados:
                ...
                # EPIs e Medidas Preventivas (interface simplificada)
